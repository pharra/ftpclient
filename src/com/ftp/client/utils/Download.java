...
public class Download extends ConnectionMode {
    ...
    public Download(String url,String username,String password) throws Exception{
        this.url=url;
    ...
    private void downFile(String from_file_name,String to_path,Socket dataSocket,boolean append) throws Exception {
     ...
     * @throws Exception
     */
    public void downloadPort(String from_file_name,String to_path) throws Exception {
     ...
     * @throws Exception
     */
    public void downloadPasv(String from_file_name,String to_path) throws Exception{
     ...
     * @throws Exception
     */
    public void downloadBrokenFile(String from_file_name,String to_path,long size) throws Exception{
        int dataPort = this.getPasvPort();
